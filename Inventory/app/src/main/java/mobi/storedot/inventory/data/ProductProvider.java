...
public class ProductProvider extends ContentProvider {
    ...
    static {
        ...
        // should recognize. All products added to the UriMatcher have a corresponding code to return
        // when a match is found.

        // The content URI of the form "content://mobi.storedot.inventory/products" will map to the
        ...
        // For example, "content://mobi.storedot.inventory/products/3" matches, but
        // "content://mobi.storedot.inventory/products" (without a number at the end) doesn't match.
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            case PRODUCTS:
                ...
                // could contain multiple rows of the prodcuts table.
            ...
            case PRODUCTS_ID:
                ...
                // For an example URI such as "content://mobi.storedot.inventory/products/3",
    ...
    private Uri insertProduct(Uri uri, ContentValues values) {
        ...
        // If the price is provided, check that it's greater than or equal to 0 CHF
    ...
    private int updateProduct(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        if (values.containsKey(ProductEntry.COLUMN_PRODUCT_QUANTITY)) {
            // Check that the price is greater than or equal to 0 CHF
            Integer quantity = values.getAsInteger(ProductEntry.COLUMN_PRODUCT_QUANTITY);
            if (quantity != null && quantity < 0) {
                throw new IllegalArgumentException("Product requires valid quantity");
            }
